export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1eVTQSbeMReIYcxAKSfGXpVHwYbwuVqc0/view?usp=sharing",
  linkedin: "https://www.linkedin.com/in/ganeshbalaraju/",
  twitter: "https://twitter.com/GaneshBalaraju",
  insta: "https://www.instagram.com/chikkibhoii/",
  facebook: "",
};
...
export const education = [
  ...
  {
    id: 1,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6x9GBIn19I1ndvZitvY9r8901cXDzvsDMzJ07nDi66NAyKZgU82BybhXeBhw8dy-OWeA&usqp=CAU",
    school: "CPCL Polytechnic College, Chennai",
    date: "Junly 2016 - Apr 2019",
    grade: "72%",
    desc: "I completed my diploma education at CPCL Polytechnic Collge, Chennai, where I studied Mechanical Engineering.",
    degree: "Diploma, Mechanical Engineering",
  },
  {
    id: 2,
    img: "https://gkjainschools.org/wp-content/uploads/2020/05/imageedit_1_2107147445.png",
    school: "Shree G.K Jain Higher Secondary School, Chennai",
    date: "Apr 2016",
    grade: "80%",
    desc: "I completed my class 10 education at G.K School, Chennai, where I studied Science with Computer Application.",
    degree: "SSLC, Science with Computer science",
  },
];
...
export const projects = [
  {
    ...
    description:
      "Post Wizards is an AI-based social media content creator platform that uses Facebook's LAMA model and employs end-to-end data encryption using the RSA algorithm.",
    image:
      "../project3.png",
    tags: [
      "React Js",
    ...
    category: "web app",
    github: "https://github.com/Lalithsha/Post-Wizards",
    webapp: "https://post-wizards.vercel.app",
  },
  {
    id: 1,
    title: "Genius",
    ...
    description:
      "Developed an AI-powered SaaS platform that facilitates conversations, code generation, image processing, music composition, and video generation. The backend database used Prisma DB, and Stripe integration was implemented for both free and paid tiers.",
    image:
      "../project1.png",
    tags: [
      "Next Js",
    ...
    webapp: "https://ai-saas-beige.vercel.app/",
  },

  {
    ...
    date: "Aug 2023",
    description:
      "ChatGPT 3.5 Turbo-Powered Travel Planner for Your Custom Trips and Adventures, Using Next.js.",
    image:
      "../project2.png",
    tags: ["React Js", "Next Js", "Clerk", "Node JS", "Shadcn UI", "Chat-GPT 3.5 REST API"],
    category: "web app",
    github: "https://github.com/Lalithsha/Travel-it-ai",
    webapp: "",
  },
  {
    id: 7,
    ...
    description:
      "A simple News app which uses kotlin and Rest API to display the lates news info.",
    image:
      "../android1.jpg",
    tags: ["Kotlin", "Android Studio", "REST API"],
    category: "android app",
    github: "https://github.com/Lalithsha/News-App",
    webapp: "https://github.com/Lalithsha/News-App",
  },
